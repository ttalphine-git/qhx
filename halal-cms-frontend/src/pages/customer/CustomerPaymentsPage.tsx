      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white p-4 rounded-lg shadow border-l-4 border-red-500">
            ...
            <p className="text-2xl font-bold text-red-600">RM {stats.totalPendingAmount.toFixed(2)}</p>
          </div>
          <div className="bg-white p-4 rounded-lg shadow border-l-4 border-green-500">
            <p className="text-sm text-gray-600">Amount Paid</p>
            <p className="text-2xl font-bold text-green-600">RM {stats.paidAmount.toFixed(2)}</p>
          </div>
        </div>
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-sm font-semibold text-gray-900">Paid On</th>
