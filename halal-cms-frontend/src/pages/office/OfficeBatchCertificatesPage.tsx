...
export default function OfficeBatchCertificatesPage() {
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-sm font-semibold text-gray-900">Producer</th>
              ...
              <tbody className="divide-y">
                {requests.map(req => (
                  <tr key={req.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-3">{req.producerName}</td>
                    <td className="px-6 py-3">{req.totalWeightKg.toFixed(2)} kg</td>
                    <td className="px-6 py-3">RM {req.totalFee.toFixed(2)}</td>
                    <td className="px-6 py-3">
                    ...
                    <td className="px-6 py-3">
                      <div className="flex items-center gap-2">
                        <button
                          onClick={() => navigate(`/office/batch-certificates/${req.id}`)}
